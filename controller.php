...
/* Config Start */
		...
		$config1['routeName'] = t('Package Config Entires');
		...
		$config4['routeName'] = t('Package Update Config Entires');
		...
		$config5['routeName'] = t('Package Delete Config Entires');
		$config5['class'] = 'package_config';
		$config5['method'] = 'destory';
		$config5['via'][] = 'post';
/* Config End */
